<template>
    <AuthLayout>
        <div>
            <h2 class="text-xl font-semibold mb-1 text-gray-900 dark:text-white">Nueva contraseña</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Elige una contraseña segura para tu cuenta.</p>
            ...
            <div v-if="success"
                ...
                <div>
                    ...
                    <p class="mt-0.5 opacity-80">Ya puedes iniciar sesión con tu nueva contraseña.</p>
                </div>
            </div>
            ...
            <p v-if="success" class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
...
const errorMsg = computed(() => {
    ...
    return Object.values(error.value).flat()[0] || "Error al restablecer la contraseña";
});
...
async function handleReset() {
    ...
    if (!token) {
        localError.value = "Enlace de recuperación inválido. Solicita uno nuevo.";
        return;
    }
